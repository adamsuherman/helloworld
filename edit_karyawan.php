    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <i class="fa fa-fw fa-table"></i><strong> Edit Karyawan</strong>
                <div class="pull-right">
                </div>
                </div>
<div class="panel-body">
<form action="edit_karyawan_proses.php" method="post" class="form">
<?php
  ...
  $show = mysql_query("SELECT * FROM tbl_karyawan WHERE ID_karyawan='$id'");
...
<input type="text" name="nama_karyawan" class="form-control" placeholder="Nama" value="<?php echo $data['nama_karyawan']; ?> " required><br>
<label class="control-label col-sm-2">Department:</label><br><br>
  <input type="radio" name="depart" value="1" <?php if($data['ID_department'] == '1'){ echo 'selected'; } ?> required>1. Press & Cutt<br>   
  <input type="radio" name="depart" value="2" <?php if($data['ID_department'] == '2'){ echo 'selected'; } ?> required>2. Welding<br>
  <input type="radio" name="depart" value="3" <?php if($data['ID_department'] == '3'){ echo 'selected'; } ?> required>3. Painting<br>    
  <input type="radio" name="depart" value="4" <?php if($data['ID_department'] == '4'){ echo 'selected'; } ?> required>4. Assembling<br>
  <input type="radio" name="depart" value="5" <?php if($data['ID_department'] == '5'){ echo 'selected'; } ?> required>5. Warehouse<br><br>
