                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Press & Cutt Department
                        </h1>
                     	<a href="save_press.php" class="btn btn-success" >Convert to Excel</a></tr>
						<a href="hapus_press.php?id="onclick="return confirm('Anda yakin akan menghapus semua data evaluasi?')" class="btn btn-danger">Hapus</a><br><br>
	</div>
	</div>
	<div class="col-lg-12">
	...
	if(mysql_num_rows($query)==0){
			...
			while($data=mysql_fetch_assoc($query)){
				echo'<tr>';
					...
					?><td align="center">
                		<a href="hapus_tbl_press.php?id=<?php echo $data['ID_evaluasi_press']; ?>"onclick="return confirm('Anda yakin akan menghapus data evaluasi?')" class="btn btn-xs btn-danger">Hapus</a>
          			</td><?php
				echo '</tr>';
				$no++;
			}
