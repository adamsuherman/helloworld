            ...
            <div class="container-fluid">
                ...
                <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i><strong> Welding Department</strong>
                            <div class="pull-right">    
                            </div>
                        </div>

                        <div class="panel-body">
<form action="proses_weld.php" method="post" class="form">
<div class="well">
<b>Keterangan:</b><br>
...
<?php
    include ('conn.php');
    $sql=mysql_query('SELECT *FROM tbl_karyawan where ID_department=2;');
    ?>
...
<thead>
    ...
    include('conn.php');
    $hariini= date("Y-m-d");
    $query=mysql_query("SELECT * FROM tbl_evaluasi_weld WHERE nama_penilai_weld='$user_check' AND DATE(date_evaluasi_weld) = DATE(NOW()) ORDER BY ID_evaluasi_weld ASC") or die(mysql_error());
