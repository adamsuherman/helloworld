            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                     ...
                     <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#demo3"><i class="fa fa-fw fa-wrench"></i> Panel Admin <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="demo3" class="collapse">
                            <li>
                                <a href="tambah_akun.php">Tambah Akun</a>
                            </li>
                            <li>
...
<label class="control-label col-sm-2">Department:</label>
  <input type="radio" name="depart" value="1" required>1. Press & Cutt  
  <input type="radio" name="depart" value="2" required>2. Welding
  <input type="radio" name="depart" value="3" required>3. Painting    
  <input type="radio" name="depart" value="4" required>4. Assembling
  <input type="radio" name="depart" value="5" required>5. Warehouse<br>
