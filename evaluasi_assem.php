            ...
            <div class="container-fluid">
                ...
                <div class="panel panel-red">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i><strong> Assembling Department</strong>
                            <div class="pull-right">    
                            </div>
                        </div>

                        <div class="panel-body">
<form action="proses_assem.php" method="post" class="form">
<div class="well">
<b>Keterangan:</b><br>
...
<?php
    include ('conn.php');
    $sql=mysql_query('SELECT *FROM tbl_karyawan where ID_department=4;');
    ?>
...
<div class="panel panel-heading"><strong>Hasil evaluasi</strong></div>
<div class="panel-body">
...
<thead>
    ...
    include('conn.php');
    $hariini= date("Y-m-d");
    $query=mysql_query("SELECT * FROM tbl_evaluasi_assem WHERE nama_penilai_assem='$user_check' AND DATE(date_evaluasi_assem) = DATE(NOW()) ORDER BY ID_evaluasi_assem ASC") or die(mysql_error());
