            ...
            <div class="container-fluid">
                ...
                <div class="panel panel-primary">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i><strong> Painting Department</strong>
                            <div class="pull-right">    
                            </div>
                        </div>

                        <div class="panel-body">
<form action="proses_paint.php" method="post" class="form">
<div class="well">
<b>Keterangan:</b><br>
...
<?php
    include ('conn.php');
    $sql=mysql_query('SELECT *FROM tbl_karyawan where ID_department=3;');
    ?>
...
<thead>
    ...
    include('conn.php');
    $hariini= date("Y-m-d");
    $query=mysql_query("SELECT * FROM tbl_evaluasi_paint WHERE nama_penilai_paint='$user_check' AND DATE(date_evaluasi_paint) = DATE(NOW()) ORDER BY ID_evaluasi_paint ASC") or die(mysql_error());
