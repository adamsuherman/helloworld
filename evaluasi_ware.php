            ...
            <div class="container-fluid">
                ...
                <div class="panel panel-yellow">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i><strong> Warehousing Department</strong>
                            <div class="pull-right">    
                            </div>
                        </div>

                        <div class="panel-body">
<form action="proses_ware.php" method="post" class="form">
<div class="well">
<b>Keterangan:</b><br>
...
<?php
    include ('conn.php');
    $sql=mysql_query('SELECT *FROM tbl_karyawan where ID_department=5;');
    ?>
...
<thead>
    ...
    include('conn.php');
    $hariini= date("Y-m-d");
    $query=mysql_query("SELECT * FROM tbl_evaluasi_ware WHERE nama_penilai_ware='$user_check' AND DATE(date_evaluasi_ware) = DATE(NOW()) ORDER BY ID_evaluasi_ware ASC") or die(mysql_error());
